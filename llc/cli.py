...
from llc.cli.options import run_shared_options, sweep_shared_options, analyze_shared_options
...
def plot_sweep_cmd(csv_path, out_dir, size_col, samplers, filters, logx, overwrite):
    ...
    return plot_sweep_entry(csv_path, out_dir, size_col, samplers, filters, logx, overwrite)
